...
const NavBar = () => {
  ...
  return (
    <div className="flex items-center justify-between h-24 max-w-[1240px] mx-auto px-4 text-white">
      <h1 className="w-full text-3xl font-bold text-[#00df9a]">Me.</h1>
      ...
      >
        <div>
          <h1 className="w-full text-3xl mt-[30px] font-bold text-[#00df9a] m-4">
            React.
          </h1>
          <ul className="p-2 uppercase">
            <li className="p-4 border-b border-gray-600">Home</li>
            <li className="p-4 border-b border-gray-600">Company</li>
            <li className="p-4 border-b border-gray-600">Rescources</li>
